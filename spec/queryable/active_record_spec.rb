...
require './lib/queryable/active_record'
require 'support/active_record_queries'

describe Queryable::ActiveRecord do
  ...
  context 'using direct inclusion' do
    ...
    describe 'chains active record criteria methods' do
      Given do
    ...
    describe 'delegates active record aggregation methods' do
      Given do
